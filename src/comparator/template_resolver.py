...
TemplateResolverMixin: plugin-name resolution, the /translate API call,
Debezium v1->v2 translate helper, SM template fetching, transforms
classification, and FM template discovery/selection/loading.
