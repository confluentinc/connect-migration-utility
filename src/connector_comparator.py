...
from comparator.config_mapper import ConfigMapperMixin
from comparator.config_deriver import ConfigDeriverMixin


class ConnectorComparator(TemplateResolverMixin, ConfigMapperMixin, ConfigDeriverMixin):
