...
DISCOVERED_CONFIGS_DIR = "discovered_configs"
SUCCESSFUL_CONFIGS_DIR = "successful_configs"
UNSUCCESSFUL_CONFIGS_DIR = "unsuccessful_configs"
...
def main():
    ...
    discovered_dir = output_dir / DISCOVERED_CONFIGS_DIR
    discovered_dir.mkdir(exist_ok=True)
    
    successful_dir = discovered_dir / SUCCESSFUL_CONFIGS_DIR
    successful_dir.mkdir(exist_ok=True)
    
    unsuccessful_dir = discovered_dir / UNSUCCESSFUL_CONFIGS_DIR
    ...
    try:
        ...
        if args.config_file and args.config_dir:
            ...
            merged_dir = output_dir / DISCOVERED_CONFIGS_DIR / 'sm_configs_compiled'
