"""
Apache Connect Migration Utility — Connector config discovery.
...
class ConfigDiscovery:
    ...
    def __init__(
        ...
        self.static_sensitive_configs = list(STATIC_SENSITIVE_CONFIGS)
        self.sensitive_patterns = list(SENSITIVE_PATTERNS)
        self.file_sensitive_configs: Set[str] = set()
    ...
    def _load_configs_from_file(
        self, file_path: str, allowed_prefixes: Optional[List[str]] = None
    ) -> Dict[str, str]:
    ...
    def get_json_from_url(
        ...
        """Make an HTTP GET request and return JSON data."""
        if logger is None:
    ...
    def get_connector_configs_from_worker(
        ...
        try:
            ...
            connectors_data = ConfigDiscovery.get_json_from_url(
    ...
    def get_connector_statuses_from_worker(
        ...
        try:
            ...
            connector_statuses_map: Dict[str, Any] = {}
            for connector_name, connector_data in connectors_data.items():
    ...
    def discover_and_save(self) -> Path:
        ...
        if self.worker_config_file:
            worker_configs = self._load_configs_from_file(
                self.worker_config_file, allowed_prefixes=self.worker_configs
            )
        ...
        for worker_url in self.worker_urls:
            ...
            configs = ConfigDiscovery.get_connector_configs_from_worker(
